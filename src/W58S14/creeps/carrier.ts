	...
	run: function (creep: Creep) {
		...
		if (creep.room.name !== Home) {
			...
			if (creep.memory.working) {
				...
				targets.sort((a: any, b: any) => (a.store.energy / a.store.getCapacity(RESOURCE_ENERGY)) - (b.store.energy / b.store.getCapacity(RESOURCE_ENERGY)));
				...
				if (closestTarget) {
					...
					towers.sort((a: any, b: any) => (a.store.energy / a.store.getCapacity(RESOURCE_ENERGY)) - (b.store.energy / b.store.getCapacity(RESOURCE_ENERGY)));
