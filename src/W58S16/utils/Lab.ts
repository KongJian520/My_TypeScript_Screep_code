    ...
    reverseReactionGO: function () {
        ...
        if (Lab3.mineralType == "GO") {
            switch (Lab3.reverseReaction(Lab1, Lab2)) {
                case 0: console.log('成功分解'); break;
                case -6: console.log('没有足够的可供分解'); break;
                case -8: console.log('有输出 lab 无法存放更多资源。'); break;
                case -10: console.log('该资源无法进行还原。'); break;
                case -11: console.log('该 lab 尚在冷却'); break;
                case -14: console.log('房间控制器等级不足。'); break;
            }
        }
    }
    ,
    runReactionGH: function () {
        ...
        if (Lab1.mineralType == "G" && Lab2.mineralType == "H") {
            switch (Lab3.runReaction(Lab1, Lab2)) {
                case 0: console.log('成功合成GH'); break;
                case -6: console.log('没有足够资源的可供合成'); break;
                case -8: console.log('Lab3满了'); break;
                case -10: console.log('该资源无法合成'); break;
                case -11: console.log('该 lab 尚在冷却'); break;
                case -14: console.log('房间控制器等级不足。'); break;
            }
        }
