        ...
        if (harvesters.length == 0) {
            ...
            if (dismoveableminers.length === 1 && dismoveableminer2s.length === 1) {
                ...
                if (roledismoveabletrasfers.length < 1) {
                    ...
                    Spawn.spawnCreep([CARRY, CARRY, CARRY, MOVE], newName,
                    ...
                    if (carriers.length < 2) {
                        ...
                        if (upgraders.length < 1) {
                            ...
                            Spawn.spawnCreep([WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE], newName,
                            ...
                            if (builders.length == 0) {
                                ...
                                Spawn.spawnCreep([WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE], newName,
