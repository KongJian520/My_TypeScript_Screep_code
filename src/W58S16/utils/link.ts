const link = {
    run: function () {
        var sourceLink1 = Game.getObjectById('64b54598c5f7ddf2f409c8f1') as StructureLink;
        var sourceLink2 = Game.getObjectById('64c3dcfa7b156580e8312d07') as StructureLink;
